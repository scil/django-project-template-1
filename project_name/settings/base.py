...
# 3 or 4
#   4:  root_dir/project_name/settings/base.py
#   3:  root_dir/settings/base.py
...
DJ_PROJECT_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
""" set in dev.py or production.py
